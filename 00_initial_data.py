...
for board in boards:
    ...
    headers = {
        ...
        "Authorization": "eyJhbGciOiJIUzI1NiJ9.eyJ0aWQiOjQ1MDQxNzgyOSwiYWFpIjoxMSwidWlkIjo2OTg5Njk4OSwiaWFkIjoiMjAyNC0xMi0yMFQxMjo1Njo1Ny41MDVaIiwicGVyIjoibWU6d3JpdGUiLCJhY3RpZCI6MTY0NTIwMDksInJnbiI6InVzZTEifQ.NTYglIQpRbKqH_NHff9C3WN9dn91a4REwQkD7z9covM",
    }
...
with open("initial_data/init.json", "w") as f:
